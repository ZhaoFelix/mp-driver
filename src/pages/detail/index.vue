                ...
                <van-col>
                  <van-row>
                    <van-col>
                      ...
                      <div class="limit-common" v-if="orderInfo.order_type == 1">
                        {{ "装修面积：" + orderInfo.order_size + " m²" }}
                      </div>
                        <div class="limit-common" v-else-if="orderInfo.order_type == 2">
                        商业装修
                      </div>
                      <div class="limit-common" v-else-if="orderInfo.order_type == 3">
                        {{ "垃圾箱数量：" + orderInfo.box_number + " 箱" }}
                      </div>
                    </van-col>
                    <van-col>
                      <button
